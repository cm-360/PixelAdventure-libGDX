...
import com.github.cm360.pixadv.graphics.gui.Layer;
import com.github.cm360.pixadv.graphics.gui.Menu;
...
public class Picasso {
	...
	public void render(Universe universe) {
		...
		if (registry.isInitialized()) {
			batch.draw(registry.getTexture(new Identifier("pixadv", "badlogic.jpg")), 0, 0, 200, 200);
