...
import com.github.cm360.pixadv.modules.builtin.entities.capabilities.FlyingEntity;
import com.github.cm360.pixadv.modules.builtin.entities.capabilities.PlayerEntity;
...
public class HumanPlayer extends Human implements PlayerEntity, FlyingEntity {
	...
	public HumanPlayer(BufferedImage skin) {
		inputs = Set.of();
		this.skin = skin;
		flying = true;
		// Movement stats
